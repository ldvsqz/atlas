...
class Util {
    ...
    selectMembershipMessage(name, until) {
        ...
        if (diffDays < 0) {
            return `Hola, ${name}. Esperamos que estés muy bien 😊 tu membresía ya venció el ${membershipDate.toLocaleDateString()} ❌ te invitamos a renovarla para continuar con tus entrenamientos 🥊`;
        } else if (diffDays <= 7) {
